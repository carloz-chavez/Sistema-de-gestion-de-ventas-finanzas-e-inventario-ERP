...
export function Sidebar() {
  ...
  return <aside className="sidebar">
    ...
    <div className="user"><span className="avatar">CD</span><div><strong>Carlos Daniel</strong><small>Administrador</small></div><form action={logout}><button aria-label="Cerrar sesión"><LogOut size={17}/></button></form></div>
  </aside>;
}
